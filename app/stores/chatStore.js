  ...
  const createNewChat = async () => {
    try {
      ...
      messages.value = [
        {
          id: Date.now(),
          text: ` سلام  به کپشن ساز خوش اومدی :) 
          اگر اولین بارته از من استفاده میکنی حتما آموزش رو بخون : 
          1- هرچیزی که فکرش رو بکنی داخل تنظیمات موجوده 
          تنظیمات برای کامپیوتر ها در سمت راست صفحه موجود هستند و برای تلفن های همراه کافیه روی دکمه تنظیمات کلیک کنید
          2- گزینه های تنظیمات شامل : تغییر هوش مصنوعی ، تغییر حالت ، تغییر لحن و تولید عکس و برنامه می باشد
          3- در صورت وجود هرگونه سوال میتونی به پشتیبانی تیکت بدی تا در سریع ترین زمان ممکن بهت کمک کنیم 
          `,
          isUser: false,
          timestamp: new Date(),
          shouldAnimate: false,
