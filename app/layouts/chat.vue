<template>
  <div
    class="w-full flex items-center justify-start min-h-screen h-screen flex-col p-1 bg-linear-to-r from-purple-600 to-pink-600"
  >
    <div
    ...
    <div class="w-full h-full bg-linear-to-r from-purple-600 to-pink-600 p-1">
      <div class="w-full bg-white rounded-lg h-full py-4 px-2">
        <slot />
      </div>
    </div>
  </div>
