...
useHead({
  ...
  meta: [
    ...
    { property: "og:url", content: "https://captionsaz.ir/upgrade" },
  ],
  link: [{ rel: "canonical", href: "https://captionsaz.ir/upgrade" }],
});
...
const plans = [
  {
    ...
    products: [
      ...
      { title: "تولید عکس با AI (1 عدد)", isValid: true },
  ...
  },
  {
    ...
    products: [
      ...
      { title: "دسترسی به هشتگ ها", isValid: true },
      { title: "تولید عکس با AI (10 عدد)", isValid: true },
  ...
  },
  {
    ...
    products: [
      ...
      { title: "دسترسی به هشتگ ها", isValid: true },
      { title: "تولید عکس با AI (40 عدد)", isValid: true },
      { title: "پشتیبانی اولویت دار", isValid: true },
      { title: "امکان دسترسی به مدل های دیگر", isValid: true },
      { title: "امکان استفاده از برنامه ریز", isValid: true },
    ],
